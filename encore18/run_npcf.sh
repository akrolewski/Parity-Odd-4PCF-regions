...
# File directories
root=galaxy_DR12v5_CMASS_North_no_WEIGHT_NOZ_cart # root for data filenames
ranroot=random0_DR12v5_CMASS_North_cart # root for random filenames
in=/gpfs/akrolewski/parity_odd_4pcf/data # input directory (see above for required contents)
out=/gpfs/akrolewski/parity_odd_4pcf/out/18_bins/boss_cmass_CMASS_no_WEIGHT_NOZ/N # output file directory
tmp=/gpfs/akrolewski/scratch/data_CMASS_no_WEIGHT_NOZ # temporary directory for intermediate file storage for this run (ideally somewhere with fast I/O)
