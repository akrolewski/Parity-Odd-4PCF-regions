...
# File directories
root=galaxy_DR12v5_CMASSLOWZTOT_North_reg2_zcut_0.43_0.70_cart # root for data filenames
ranroot=random0_DR12v5_CMASSLOWZTOT_North_reg2_zcut_0.43_0.70_cart # root for random filenames
in=/gpfs/akrolewski/parity_odd_4pcf/data # input directory (see above for required contents)
out=/gpfs/akrolewski/parity_odd_4pcf/out/18_bins/boss_cmass_reg2/N # output file directory
tmp=/gpfs/akrolewski/scratch/data_reg2 # temporary directory for intermediate file storage for this run (ideally somewhere with fast I/O)
