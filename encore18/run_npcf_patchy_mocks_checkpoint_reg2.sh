...
#SBATCH -p preq
#SBATCH --dependency=afterany:118902
...
in=/gpfs/akrolewski/parity_odd_4pcf/data/patchy_mocks/reg2/05/ # input directory (see above for required contents)
out="/gpfs/akrolewski/parity_odd_4pcf/out/18_bins/patchy_mocks_reg2/N/${SLURM_ARRAY_TASK_ID}/" # output file directory
tmp="/gpfs/akrolewski/scratch/18_bins/patchy_mocks_reg2/N/${ID}" # temporary directory for intermediate file storage for this run (ideally somewhere with fast I/O)
