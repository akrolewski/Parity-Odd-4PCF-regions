...
for j in range(10,101):
	if rank+10 == j:
		...
		#j = 0
		#j = 0
		#print(os.path.exists('/gpfs/akrolewski/parity_odd_4pcf/data/patchy_mocks/Patchy-Mocks-DR12CMASS/cart_files_default/Patchy-Mocks-DR12CMASS-%s-V6C-Portsmouth-mass_%04d_cart.ran.%02d' % (hemi, j+1, 0)))
		#print('/gpfs/akrolewski/parity_odd_4pcf/data/patchy_mocks/Patchy-Mocks-DR12CMASS/cart_files_default/Patchy-Mocks-DR12CMASS-%s-V6C-Portsmouth-mass_%04d_cart.ran.%02d' % (hemi, j+1, 0))
		...
		np.savetxt('/gpfs/akrolewski/parity_odd_4pcf/data/patchy_mocks/Patchy-Mocks-DR12CMASS/cart_files_default/Patchy-Mocks-DR12CMASS-%s-V6C-Portsmouth-mass_%04d_no_WEIGHT_CP_cart.data' % (hemi, j+1),out)
		print(j)
		...
		weight = data[:,5][data_inds] /(1 + 10000*data[:,3][data_inds])
		...
		for i in range(32):
			if (i == 0) or (j == 0):
				...
				np.savetxt('/gpfs/akrolewski/parity_odd_4pcf/data/patchy_mocks/Patchy-Mocks-DR12CMASS/cart_files_default/Patchy-Mocks-DR12CMASS-%s-V6C-Portsmouth-mass_%04d_no_WEIGHT_CP_cart.ran.%02d' % (hemi, j+1, i),out)
