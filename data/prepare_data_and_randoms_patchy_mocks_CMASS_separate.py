...
for j in range(100):
	if rank == j%64:
		...
		np.savetxt('/gpfs/akrolewski/parity_odd_4pcf/data/patchy_mocks/Patchy-Mocks-DR12CMASS/cart_files_default/Patchy-Mocks-DR12CMASS-%s-V6C-Portsmouth-mass_%04d_cart.data' % (hemi, j+1),out)
		print(j)
		...
		for i in range(32):
			if (i == 0) or (j == 0):
				...
				np.savetxt('/gpfs/akrolewski/parity_odd_4pcf/data/patchy_mocks/Patchy-Mocks-DR12CMASS/cart_files_default/Patchy-Mocks-DR12CMASS-%s-V6C_x100-Portsmouth-mass_%04d_cart.ran.%02d' % (hemi, j+1, i),out)
